...
public class TestMMapFileBackedBitArray {
	...
	public void testGetAndSet() throws Exception {
		...
		file.deleteOnExit();
		BitArray ba = new MMapFileBackedBitArray(file, MAX_ELEMENTS);
	...
	public void testOr() throws Exception {
		...
		file1.deleteOnExit();
		BitArray ba1 = new MMapFileBackedBitArray(file1, MAX_ELEMENTS);

		File file2 = File.createTempFile("test-ba-", ".bin");
		file2.deleteOnExit();
		BitArray ba2 = new MMapFileBackedBitArray(file2, MAX_ELEMENTS);
